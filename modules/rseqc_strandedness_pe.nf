...
process RSEQC_STRANDEDNESS_PE {
    ...
    FORWARD=\$(grep 'Fraction of reads explained by "1++,1--,2+-,2-+"' ${bam_file.simpleName}.infer_experiment.txt | awk '{print \$NF}')
    REVERSE=\$(grep 'Fraction of reads explained by "1+-,1-+,2++,2--"' ${bam_file.simpleName}.infer_experiment.txt | awk '{print \$NF}')
